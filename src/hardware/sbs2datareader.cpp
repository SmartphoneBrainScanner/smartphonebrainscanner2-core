...
void Sbs2DataReader::turnReceiveUdpDataOn(QString address, int port) { Q_UNUSED(address); Q_UNUSED(port);}
...
void Sbs2DataReader::udpDataReceived(QUdpSocket *rawDataUdpInputSocket) {Q_UNUSED(rawDataUdpInputSocket);}
