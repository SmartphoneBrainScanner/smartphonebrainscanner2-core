...
/* calculates the trace for a square matrix */
// template <class T>
// inline T Array2D<T>::getTrace()
// {
    // if (m_ == n_) {
        // T trace;
        // for (int i=0; i<m_; i++)
...
/* inverts the matrix 
template <class T>
inline void Array2D<T>::pseudoinvert()
{
    // do pseudoinverse with the results of SVD
